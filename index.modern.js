...
import { is, curry, gte, lte, path } from 'ramda';

var ReducersProvider = createContext();
...
Object.keys(Modules).forEach(function (module) {
  ...
  reducers[module] = createReducer(INITIAL_STATE, _extends({}, mapActionReducer));
});
...
var rootReducers = function rootReducers(history) {
  return combineReducers(reducers$1(history));
};
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 6:
              ...
              _context.next = 11;
              return call(moduleActions[action].api, data);
            ...
            case 15:
              _context.next = 17;
              return put(Creators[action + "Success"](resp.data));
            ...
            case 20:
              ...
              _context.next = 25;
              return put(Creators[action + "Error"](getErrorMessage(_context.t0)));
...
var composeEnhancers = process.env.REACT_APP_LOGGING_ENABLED ? window.__REDUX_DEVTOOLS_EXTENSION_COMPOSE__ || compose : compose;
...
var store = createStore(reducers$2, composeEnhancers(applyMiddleware.apply(void 0, middlewares)));
...
Object.keys(Modules).forEach(function (module) {
  ...
  selectors[module] = {
    state: createSelector(getState, function (state) {
      return state;
    })
  };
});
...
var Provider = (function (_ref) {
  ...
  return /*#__PURE__*/React.createElement(Provider$1, {
    store: store
  }, /*#__PURE__*/React.createElement(ReducersProvider.Provider, {
    value: {
      actions: actions,
      selectors: selectors
    }
...
var useActions = (function () {
  ...
  var _useContext = useContext(ReducersProvider),
      actions = _useContext.actions;

  var request = useCallback(function (_ref) {
...
var useSelectors = (function (module) {
  ...
  var valueProp = useSelector(function (state) {
...
var isWithin = curry(function (min, max, value) {
  return isNumber(min) && isNumber(max) && isNumber(value) && gte(value, min) && lte(value, max);
});
